...
fun WhatsAppMainScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Signal", fontWeight = FontWeight.Bold, color = Color.White) },
        ...
        floatingActionButton = {
            FloatingActionButton(onClick = {}, containerColor = SignalBlue, contentColor = Color.White) {
                Icon(when(tab){0->Icons.Default.Edit;1->Icons.Default.Call;else->Icons.Default.Add}, null)
            }
        }
    ) { pad ->
